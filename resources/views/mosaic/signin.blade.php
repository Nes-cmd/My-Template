...
<!-- Mirrored from preview.cruip.com/mosaic/signin.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Mar 2022 08:18:25 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <main class="bg-white">
        ...
        <div class="td flex">
                ...
                <div class="ow sz flex fu wu">
                    ...
                    <div class="at ri va vf">
                        ...
                        <form>
                            <div class="fj">
                                <div>
                                    <label class="block text-sm gm rx" for="email">Email Address</label>
                                    <input id="email" class="tn ox" type="email">
                                </div>
                                <div>
                                    <label class="block text-sm gm rx" for="password">Password</label>
                                    <input id="password" class="tn ox" type="password" autocomplete="on">
                                </div>
                            </div>
                            <div class="flex items-center fh ir">
                                <div class="mr-1">
                                    <a class="text-sm bt xb" href="reset-password.html">Forgot Password?</a>
                                </div>
                                <a class="btn hd wq ye ml-3" href="index.html">Sign In</a>
                            </div>
                        </form>
                        <!-- Footer -->
                        <div class="m_ ir cg border-slate-200">
                            <div class="text-sm">
                                Don’t you have an account? <a class="gm text-indigo-500 xu" href="signup.html">Sign Up</a>
                            </div>
                            <!-- Warning -->
                            <div class="id">
                                <div class="hk yo vx vc rounded">
                                    <svg class="inline w-3 h-3 af dd" viewBox="0 0 12 12">
            ...
            <div class="hidden qe tp tk ty tw qa" aria-hidden="true">
                <img class="dj dq ox sz" src="images/auth-image.jpg" width="760" height="1024" alt="Authentication image">
