...
<!-- Mirrored from preview.cruip.com/mosaic/onboarding-03.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Mar 2022 08:18:49 GMT -->
<head>
    <meta charset="utf-8">
    <title>Mosaic HTML Demo - Onboarding 03</title>
    ...
    <main class="bg-white">
        ...
        <div class="td flex">
            ...
            <div class="ox qa">
                ...
                <div class="ow sz flex fu wu">

                    <div class="au">

                        <!-- Header -->
                        <div class="flex items-center fh ou va jn teb">
                            <!-- Logo -->
                            ...
                            <div class="text-sm">
                                Have an account? <a class="gm text-indigo-500 xu" href="signin.html">Sign In</a>
                            </div>
                        </div>
                            ...
                            <div class="ao ri ox">
                                <div class="td">
                                    ...
                                    <ul class="td flex fh ox">
                                        <li>
                                            <a class="flex items-center justify-center oz on rounded-full gp gg hd ye" href="onboarding-01.html">1</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center oz on rounded-full gp gg hd ye" href="onboarding-02.html">2</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center oz on rounded-full gp gg hd ye" href="onboarding-03.html">3</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center oz on rounded-full gp gg hp text-slate-500" href="onboarding-04.html">4</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="va vf">
                        <div class="ao ri">
                            ...
                            <h1 class="text-3xl text-slate-800 font-bold rb">Company information ✨</h1>
                            <!-- Form -->
                            <form>
                                <div class="fj ry">
                                    <!-- Company Name -->
                                    <div>
                                        <label class="block text-sm gm rx" for="company-name">Company Name <span class="yi">*</span></label>
                                        <input id="company-name" class="tn ox" type="text">
                                    </div>
                                    <!-- City and Postal Code -->
                                    <div class="flex fq">
                                        <div class="au">
                                            <label class="block text-sm gm rx" for="city">City <span class="yi">*</span></label>
                                            <input id="city" class="tn ox" type="text">
                                        </div>
                                        <div class="au">
                                            <label class="block text-sm gm rx" for="postal-code">Postal Code <span class="yi">*</span></label>
                                            <input id="postal-code" class="tn ox" type="text">
                                        </div>
                                    </div>
                                    <!-- Street Address -->
                                    <div>
                                        <label class="block text-sm gm rx" for="street">Street Address <span class="yi">*</span></label>
                                        <input id="street" class="tn ox" type="text">
                                    </div>
                                    <!-- Country -->
                                    <div>
                                        <label class="block text-sm gm rx" for="country">Country <span class="yi">*</span></label>
                                        <select id="country" class="ts ox">
                                            <option>USA</option>
                                            <option>Italy</option>
                                ...
                                <div class="flex items-center fh">
                                    <a class="text-sm bt xb" href="onboarding-02.html">&lt;- Back</a>
                                    <a class="btn hd wq ye rz" href="onboarding-04.html">Next Step -&gt;</a>
                                </div>
                            </form>
            ...
            <!-- Image -->
            <div class="hidden qe tp tk ty tw qa" aria-hidden="true">
                <img class="dj dq ox sz" src="images/onboarding-image.jpg" width="760" height="1024" alt="Onboarding">
                <img class="tp ns tb a_ ap ij hidden zk" src="images/auth-decoration.png" width="218" height="224" alt="Authentication decoration">
            </div>
