    ...
    <div class="bg-white bh rounded-sm ry">
        <div class="flex fu qm jx">
            ...
            <div class="al">
                <!-- Panel body -->
                <div class="dz fx">
                    <h2 class="gc text-slate-800 font-bold ic">My Notifications</h2>

                    <!-- General -->
                    <section>
                        <h3 class="gh gk text-slate-800 font-bold rx">General</h3>
                        <ul>
                            <li class="flex fh items-center vl cm border-slate-200">
                                <!-- Left -->
                                <div>
                                    <div class="text-slate-800 gg">Comments and replies</div>
                                    <div class="text-sm">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit.</div>
                                </div>
                                <!-- Right -->
                                <div class="flex items-center iy" x-data="{ checked: true }">
                                    <div class="text-sm yt gw mr-2" x-text="checked ? 'On' : 'Off'"></div>
                                    <div class="tf">
                                        <input type="checkbox" id="comments" class="tc" x-model="checked" />
                                        <label class="pi" for="comments">
                            ...
                            <li class="flex fh items-center vl cm border-slate-200">
                                <!-- Left -->
                                <div>
                                    <div class="text-slate-800 gg">Messages</div>
                                    <div class="text-sm">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit.</div>
                                </div>
                                <!-- Right -->
                                <div class="flex items-center iy" x-data="{ checked: true }">
                                    <div class="text-sm yt gw mr-2" x-text="checked ? 'On' : 'Off'"></div>
                                    <div class="tf">
                                        <input type="checkbox" id="messages" class="tc" x-model="checked" />
                                        <label class="pi" for="messages">
                                            <span class="bg-white bd" aria-hidden="true"></span>
                                            <span class="tc">Enable smart sync</span>
                                        </label>
                                    </div>
                            ...
                            <li class="flex fh items-center vl cm border-slate-200">
                                <!-- Left -->
                                <div>
                                    <div class="text-slate-800 gg">Mentions</div>
                                    <div class="text-sm">Excepteur sint occaecat cupidatat non in culpa qui officia deserunt mollit.</div>
                                </div>
                                <!-- Right -->
                                <div class="flex items-center iy" x-data="{ checked: false }">
                                    <div class="text-sm yt gw mr-2" x-text="checked ? 'On' : 'Off'"></div>
                                    <div class="tf">
                                        <input type="checkbox" id="mentions" class="tc" x-model="checked" />
                                        <label class="pi" for="mentions">
                                            <span class="bg-white bd" aria-hidden="true"></span>
                                            <span class="tc">Enable smart sync</span>
                                        </label>
                                    </div>
                    ...
                    <!-- Shares -->
                    <section>
                        <h3 class="gh gk text-slate-800 font-bold rx">Shares</h3>
                        <ul>
                            <li class="flex fh items-center vl cm border-slate-200">
                                <!-- Left -->
                                <div>
                                    <div class="text-slate-800 gg">Shares of my content</div>
                                    <div class="text-sm">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit.</div>
                                </div>
                                <!-- Right -->
                                <div class="flex items-center iy">
                                    <button class="tt border-slate-200 hover--border-slate-300 bd">Manage</button>
                                </div>
                            </li>
                            <li class="flex fh items-center vl cm border-slate-200">
                                <!-- Left -->
                                <div>
                                    <div class="text-slate-800 gg">Team invites</div>
                                    <div class="text-sm">Excepteur sint occaecat cupidatat non in culpa qui officia deserunt mollit.</div>
                                </div>
                                <!-- Right -->
                                <div class="flex items-center iy">
                            ...
                            <li class="flex fh items-center vl cm border-slate-200">
                                <!-- Left -->
                                <div>
                                    <div class="text-slate-800 gg">Smart connection</div>
                                    <div class="text-sm">Excepteur sint occaecat cupidatat non in culpa qui officia deserunt mollit.</div>
                                </div>
                                <!-- Right -->
                                <div class="flex items-center iy">
                                    <div class="text-sm yt gw mr-2 hidden qe">Active</div>
                                    <button class="tt border-slate-200 hover--border-slate-300 bd yi">Disable</button>
                                </div>
                            </li>
                        </ul>
                    </section>
