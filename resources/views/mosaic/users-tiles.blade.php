    ...
    <div class="sx fi fd">
        ...
        <div class="nk kx tto bg-white bh rounded-sm border border-slate-200">
            <div class="flex fu sz">
                <div class="al vi">
                    <div class="flex fh ff">
                        <header>
                            <div class="flex in">
                                <a class="td inline-flex ff iv" href="#0">
                                ...
                                <div class="io gs">
                                    ...
                                    <div class="flex items-center"><span class="text-sm gm yt sm mr-1">-&gt;</span> <span>🇮🇹</span></div>
                                </div>
                            </div>
                        </header>
                        <div class="td inline-flex af" x-data="{ open: false }">
                    ...
                    <div class="iw"><div class="text-sm">Fitness Fanatic, Design Enthusiast, Mentor, Meetup Organizer &amp; PHP Lover.</div></div>
                </div>
                <div class="cg border-slate-200">
                    <div class="flex lp divide-slate-200r">
                        <a class="block au gu text-sm text-indigo-500 xu gm vx vj" href="messages.html">
                        ...
                        <a class="block au gu text-sm gz xl gm vx vj kr" href="settings.html">
                            <div class="flex items-center justify-center">
                                <svg class="o_ sq dd yt ks af mr-2" viewBox="0 0 16 16">
                                    <path
