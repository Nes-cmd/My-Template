...
<!-- Mirrored from preview.cruip.com/mosaic/reset-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Mar 2022 08:18:28 GMT -->
<head>
    <meta charset="utf-8">
    <title>Mosaic HTML Demo - Reset Password</title>
            ...
            <div class="ox qa">
                ...
                <div class="ow sz flex fu wu">
                    ...
                    <div class="at ri va vf">
                        ...
                        <h1 class="text-3xl text-slate-800 font-bold rb">Reset your Password ✨</h1>
                        <!-- Form -->
                        <form>
                            <div class="fj">
                                <div>
                                    <label class="block text-sm gm rx" for="email">Email Address <span class="yi">*</span></label>
                                    <input id="email" class="tn ox" type="email">
                                </div>
                            </div>
                            <div class="flex justify-end ir">
                                <button class="btn hd wq ye ct">Send Reset Link</button>
                            </div>
                        </form>
