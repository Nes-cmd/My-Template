...
<div class="td">
                ...
                <div class="lx">
                    <table class="ac ox" @click.stop="$dispatch('set-transactionopen', true)">
                        ...
                        <tbody class="text-sm lh ld cm border-slate-200">
                            ...
                            <tr class="aq" @click.stop="$dispatch('set-transactionopen', true)">
                                <td class="vg wv ww vl ct oj">
                                    <div class="flex items-center">
                                        <label class="inline-flex"> <span class="tc">Select</span> <input class="table-item to" type="checkbox" @click.stop="uncheckParent" /> </label>
                                    </div>
    ...
    <!-- Transaction Panel -->
    <div class="tp tm kv ny a_ bq wn wi" :class="transactionOpen ? 'translate-x-0' : 'aw'" @click.outside="transactionOpen = false" @keydown.escape.window="transactionOpen = false" x-cloak="">
                ...
                <div class="at ri teo">
                    ...
                    <div class="bw sp">
                        <div class="bg-white cl v_ gr gu">
                            <div class="it gu"><img class="inline-flex ua oa rounded-full sd" src="images/transactions-image-04.svg" width="48" height="48" alt="Transaction 04" /></div>
