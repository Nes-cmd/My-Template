...
<!-- Mirrored from preview.cruip.com/mosaic/onboarding-01.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Mar 2022 08:18:28 GMT -->
<head>
    <meta charset="utf-8">
    <title>Mosaic HTML Demo - Onboarding 01</title>
                ...
                <div class="ow sz flex fu wu">
                            ...
                            <div class="ao ri ox">
                                <div class="td">
                                    ...
                                    <ul class="td flex fh ox">
                                        ...
                                        <li>
                                            <a class="flex items-center justify-center oz on rounded-full gp gg hp text-slate-500" href="onboarding-02.html">2</a>
                                        </li>
                                        <li>
                                            <a class="flex items-center justify-center oz on rounded-full gp gg hp text-slate-500" href="onboarding-03.html">3</a>
                                        </li>
                                        <li>
                    ...
                    <div class="va vf">
                        <div class="ao ri">
                            ...
                            <h1 class="text-3xl text-slate-800 font-bold rb">Tell us what’s your situation ✨</h1>
                            <!-- Form -->
                            <form>
                                <div class="le ry">
                                    <label class="td block aq">
                                        <input type="radio" name="radio-buttons" class="kc tc" checked="checked">
                                        <div class="flex items-center bg-white text-sm gm text-slate-800 vn rounded border border-slate-200 hover--border-slate-300 bd we wi">
                                            <svg class="oz on af dd mr-4" viewBox="0 0 24 24">
                                ...
                                <div class="flex items-center fh">
                                    <a class="btn hd wq ye rz" href="onboarding-02.html">Next Step -&gt;</a>
                                </div>
                            </form>
