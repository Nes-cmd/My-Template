            ...
            <div>
                ...
                <article class="vj cm border-slate-200">
                    <header class="flex ff in">
                        ...
                        <h3 class="gh gk font-bold" style="color:red">Are you sure to create Roles? it's Here</h3>
                    </header>
                    <div class="w-1/2">
                        <div class="in">
                        ...
                        @endforeach
                            ...
                            <form action="{{ url('role/store') }}" method="post">
                                @csrf 
                                <label class="block text-sm gm rx" for="icon">Write name of Role</label>
                                <div class="pb-3">
                                    <div class="td">
                                        <input id="icon" class="tn ox mr" type="text" name="name">
